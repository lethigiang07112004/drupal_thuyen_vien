            ...
            <div class="container">
                ...
                <div class="utf-right-side">
                    <div class="utf-header-widget-item">
                        <a href="#utf-signin-dialog-block" class="popup-with-zoom-anim log-in-button"
                           title="<?= t('ĐĂNG KÝ TƯ VẤN') ?>"><i class="icon-line-awesome-pencil"></i>
                            <span><?= t('ĐĂNG KÝ TƯ VẤN') ?></span></a>
                    </div>
                    <span class="mmenu-trigger">
            <button class="hamburger utf-hamburger-collapse-item" type="button"> <span
                        class="utf-hamburger-box-item"> <span class="utf-hamburger-inner-item"></span> </span> </button>
          </span>
                </div>
            </div>
        </div>
                        ...
                        <ul>
                            ...
                            <?php foreach ($breadcrumb_array as $item_breadcrumb_array): ?>
                                ...
                                <li class="<?php ($run_bread == 1) ? print 'ml-5' : print ''; ?>">
                                    <?= str_replace('<a', '<a title="' . trim(strip_tags($item_breadcrumb_array)) . '" ', $item_breadcrumb_array) ?>
                                </li>
                            <?php endforeach; ?>
    ...
    <div class="<?php (arg(0) == 'don-hang-xkld') ? print 'container-fluid' : print 'container' ?>">
        <div class="utf-companies-list-aera">
            ...
            <div class="row">
                <?php
                $col = 12;
                //        if(!((isset($node->nid)&&(($node->nid)=='3'))||arg(0)=='don-hang-xkld'||arg(2)=='done'))
                //        {
                ...
                <?php if ($col != 12): ?>
                    ...
                    <div class="col-md-<?= 12 - $col ?>">
                        <?php print str_replace('<p>{{}}</p>', form_search_side(), render($page['sidebar'])); ?>
                    </div>
                <?php else: ?>
                    <div class="col-md-12">
                        <?php print render($page['content']); ?>
...
<!--                            <a href="--><?php //= $front_page ?><!--" title="Ảnh logo tuyển dụng thuyển viên"-->
<!--                               class="footer-logo mb-5"><img src="/sites/default/files/logo-footer.png" alt="Ảnh LOGO THUYỀN VIÊN"></a>-->
                            <h3><?= t('CONTACT') ?></h3>
                            <?= getnodecontent(25) ?>
                        </div>
                    </div>
