(function($) {
    ...
    $(document).ready(function() {
        ...
        var ds_the=$('body a');
        var atest=0;
        ds_the.each(function () {
          if(typeof $(this).attr('title') != "undefined")
          {}
          else {
            atest++;
            $(this).addClass('thieu_title');
          }
        });
        console.log(atest);
        /*--------------------------------------------------*/
        ...
        $('.utf-blog-carousel-block-customer').slick({
        infinite: true,
        slidesToShow: 6,
        slidesToScroll: 1,
        dots: false,
        ...
        if($('.utf-pricing-plan-features-item').length > 0)
        {
          $('.utf-pricing-plan-features-item').addClass('d-none-mb-menu');
        }
      $('.pricing-plan.recommended .button').click(function (e) {
        e.preventDefault();
        console.log('1');
        $('.utf-pricing-plan-features-item').toggle('ds_menu');
      });
    });
    /*-----------------------------------------
    /*  Preloader
